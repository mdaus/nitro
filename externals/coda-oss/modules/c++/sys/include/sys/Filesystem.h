...
bool exists(const path& p);  // https://en.cppreference.com/w/cpp/filesystem/exists
    ...
    #define CODA_OSS_DEFINE_std_filesystem_ -1  // got <filesystem>, don't need our own
    #else
    #define CODA_OSS_DEFINE_std_filesystem_ CODA_OSS_AUGMENT_std_namespace  // no <filesystem>, maybe use our own
    #endif
