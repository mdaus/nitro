...
class Poly1D(_object):
    ...
    def __itruediv__(self, cv: 'double') -> "math::poly::OneD< double > &":
        """__itruediv__(Poly1D self, double cv) -> Poly1D"""
        return _math_poly.Poly1D___itruediv__(self, cv)


    def __truediv__(self, cv: 'double') -> "math::poly::OneD< double >":
        """__truediv__(Poly1D self, double cv) -> Poly1D"""
        return _math_poly.Poly1D___truediv__(self, cv)
...
class Poly2D(_object):
    ...
    def __itruediv__(self, cv: 'double') -> "math::poly::TwoD< double > &":
        """__itruediv__(Poly2D self, double cv) -> Poly2D"""
        return _math_poly.Poly2D___itruediv__(self, cv)


    def __truediv__(self, cv: 'double') -> "math::poly::TwoD< double >":
        """__truediv__(Poly2D self, double cv) -> Poly2D"""
        return _math_poly.Poly2D___truediv__(self, cv)
...
class PolyVector3(_object):
    ...
    def __itruediv__(self, cv: 'double') -> "math::poly::OneD< math::linear::VectorN< 3,double > > &":
        """__itruediv__(PolyVector3 self, double cv) -> PolyVector3"""
        return _math_poly.PolyVector3___itruediv__(self, cv)


    def __truediv__(self, cv: 'double') -> "math::poly::OneD< math::linear::VectorN< 3,double > >":
        """__truediv__(PolyVector3 self, double cv) -> PolyVector3"""
        return _math_poly.PolyVector3___truediv__(self, cv)
