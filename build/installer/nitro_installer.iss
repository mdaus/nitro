...
OutputBaseFilename=nitro-2.5-rc7-setup
UninstallDisplayName=NITRO 2.5-rc7
...
;Source: "..\..\python\nitf\dist\nitro-python-2.5-rc7.win32.exe"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Components: python;
...
[Run]
Filename: "{app}\nitro-python-2.5-rc7.win32.exe"; Description: "Install Python Bindings"; Flags: skipifsilent skipifdoesntexist
