...
#ifndef __MT_THREAD_WIN32_H__
#define __MT_THREAD_WIN32_H__
...
public:
    ...
    ThreadWin32(mt::Runnable *target,
    ...
    virtual void kill()
    {
        throw mt::ThreadResourceException("kill() not implemented in ThreadWin32");
    }
    virtual void join();
    static void yield()
    {
        ...
        SwitchToThread();
#else
        throw mt::ThreadResourceException("Thread::yield() only supported in windows NT 4.0 or greater!");
#endif
