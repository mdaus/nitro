...
#ifndef __MT_THREAD_SOLARIS_CONDITION_VARIABLE_H__
#define __MT_THREAD_SOLARIS_CONDITION_VARIABLE_H__
 ...
 */
class ConditionVarSolaris : public mt::ConditionVarInterface
{
public:
    ConditionVarSolaris();
