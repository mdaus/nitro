...
mt::SyncFactoryIrix::SyncImplIrix* mt::SyncFactoryIrix::mImpl = NULL;
mt::SyncFactoryIrix::SyncImplIrix::SyncImplIrix() : mRef(0), mArena(NULL)
{
...
mt::SyncFactoryIrix::SyncImplIrix::~SyncImplIrix()
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::startThread(mt::ThreadIrix& t)
{
    dbg_ln("Starting thread");
    t.getNative() = sproc(mt::ThreadIrix::__start,
...
bool mt::SyncFactoryIrix::SyncImplIrix::killThread(mt::ThreadIrix& t)
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::createLock(mt::MutexIrix& mutex)
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::destroyLock(mt::MutexIrix& mutex)
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::setLock(mt::MutexIrix& mutex)
{
    dbg_ln("Setting the lock");
    return ( ussetlock( *(mutex.getNative() ) ) == 1 );
}

bool mt::SyncFactoryIrix::SyncImplIrix::unsetLock(mt::MutexIrix& mutex)
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::waitSemaphore(mt::SemaphoreIrix& sema)
{
    dbg_ln("Waiting for semaphore");
    return ( uspsema( sema.getNative() ) == 1 );
}

bool mt::SyncFactoryIrix::SyncImplIrix::signalSemaphore(mt::SemaphoreIrix& sema)
{
    dbg_ln("Signalling semaphore");
    return ( usvsema( sema.getNative() ) == 0 );
}

bool mt::SyncFactoryIrix::SyncImplIrix::createSemaphore(mt::SemaphoreIrix& sema,
        unsigned int count)
{
...
bool mt::SyncFactoryIrix::SyncImplIrix::destroySemaphore(mt::SemaphoreIrix& sema)
{
