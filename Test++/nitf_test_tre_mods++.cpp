...
public:
	nitf_test_tre_mods__() {
		// initialization code here
		sys::OS().setEnv("NITF_PLUGIN_PATH", nitf::Test::buildPluginsDir(), true /*overwrite*/);
	}
	~nitf_test_tre_mods__() = default;
	nitf_test_tre_mods__(const nitf_test_tre_mods__&) = delete;
	nitf_test_tre_mods__& operator=(const nitf_test_tre_mods__&) = delete;
