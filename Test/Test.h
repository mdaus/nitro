...
{
	nitf::test_expect_eq_(t, u);
	nitf::test_expect_eq_(u, t);
	TEST_ASSERT(!(t != u));
	TEST_ASSERT(!(u != t));
}
...
{
	nitf::test_expect_streq_(t, u);
	nitf::test_expect_streq_(u, t);
}
...
{
	nitf::test_expect_ne_(t, u);
	nitf::test_expect_ne_(u, t);
	TEST_ASSERT(!(t == u));
	TEST_ASSERT(!(u == t));
}
